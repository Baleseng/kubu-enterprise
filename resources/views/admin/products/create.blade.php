            ...
            <div class="flex">
                    ...
                    <div class="mb-6 w-100">
                        ...
                        <div id="preview-area" class="hidden">
                            <div class="flex items-center justify-center">
                                <img id="preview-image" src="#" alt="File preview" class="h-64 rounded-lg shadow-md"/>
                            </div>
                ...
                <div class="items-center justify-center p-5 mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="mb-6 w-100">
                        ...
                        <input type="text" id="default-input" name="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                ...
                <div class="items-center justify-center p-5 mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="bg-gray-100 py-2 mb-3 border border-gray-300 rounded-lg">
                        ...
                        <div class="mb-6 w-100  px-2">
                            ...
                            <input type="text" id="default-input" value="NA" name="file_description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    ...
                    <div class="mb-6 w-full">
                        <button type="submit" class="w-full text-white text-4xl uppercase font-bold  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-4 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Product</button>
                    </div>   
