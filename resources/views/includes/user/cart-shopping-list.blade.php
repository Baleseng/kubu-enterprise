        ...
        <div class="flex items-center justify-between md:order-3 md:justify-end">
            <div class="flex items-center">
                ...
                <form method="POST" action="">
                    ...
                    <input type="number" value="{{ $item->quantity }}" name="quantity" id="quantity-input-{{ $item->product->id }}" min="0" class="border-none  placeholder:text-heading text-center w-24 py-2.5 placeholder:text-body" placeholder="0">
