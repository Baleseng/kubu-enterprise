    ...
    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 text-center">
        ...
        <td class="px-5 py-4">
            <ul class="flex flex-wrap items-center justify-center text-heading">
                <li>
                    <a href="{{ url($url.'/'. $content->folder . '/show/'.$content->id . '-' . str_replace(' ', '-', $content->name)) }}" class="me-4 md:me-6">
                        <i class="fa-solid fa-eye"></i>
                    </a>
                </li>
                <li>
                    <a href="{{ url($url.'/'. $content->folder . '/edit/'.$content->id . '-' . str_replace(' ', '-', $content->name)) }}" class="me-4 md:me-6">
