        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div id="animation-carousel" class="relative w-full" data-carousel="static">
                ...
                <div class="relative h-56 overflow-hidden rounded-base md:h-96">
                    ...
                    <div class="duration-200 ease-linear" data-carousel-item>
                        <img src="{{ url('storage/images/banner-2.png') }}" class="absolute block w-full top-0 left-0" alt="...">
                    </div>
                </div>
                <!-- Slider controls -->
            ...
            <div class=" dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @include('includes.user.items-special-cards')
            ...
            <div id="animation-carousel" class="relative w-full" data-carousel="static">
                ...
                <div class="relative h-56 overflow-hidden rounded-base md:h-96">
                     <!-- Item 1 -->
                    <div class="duration-200 ease-linear" data-carousel-item>
                        <img src="{{ url('storage/images/banner-1.png') }}" class="absolute block w-full top-0 left-0" alt="...">
                    </div>
                </div>
                <!-- Slider controls -->
                <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
            ...
            <div class=" dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @include('includes.user.items-trending-cards')
                    @include('includes.user.items-weekend-cards')
                    @include('includes.user.items-weekdays-cards')
                    @include('includes.user.items-households-cards')
                    @include('includes.user.items-partytime-cards')
